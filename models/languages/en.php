...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_REALNAME_CHAR_LIMIT"		=> "Your real name must be between %m1% and %m2% characters in length",
	...
	"ACCOUNT_REALNAME_INVALID_CHARACTERS"	=> "Real name can only include alpha-numeric characters",
	"ACCOUNT_USERNAME_IN_USE"		=> "Username %m1% is already in use",
	"ACCOUNT_REALNAME_IN_USE"		=> "Real name %m1% is already in use",
	...
	"ACCOUNT_REALNAME_UPDATED"		=> "Real name changed to %m1%",
